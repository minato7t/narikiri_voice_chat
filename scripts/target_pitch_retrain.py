...
from target_pitch_train import target_pitch_train_main
...
if __name__ == '__main__':
    ...
    target_pitch_train_main(sys.argv[2], sys.argv[3], early_stopping_patience, length, batch_size, sys.argv[1], do_compile)
