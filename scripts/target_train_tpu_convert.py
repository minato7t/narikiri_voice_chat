...
def target_train_tpu_convert_main(input_file, output_weight_file, output_json_file):
    ...
    config['layers'][4]['config']['target_shape'] = (-1, 64)
    config['layers'][5]['config']['layer']['config']['kernel_initializer'] = 'zeros'
    config['layers'][6]['config']['kernel_initializer'] = 'zeros'
    config['layers'][7]['config']['target_shape'] = (-1, 32)
    config['layers'][8]['config']['layer']['config']['kernel_initializer'] = 'zeros'
    config['layers'][9]['config']['kernel_initializer'] = 'zeros'
    config['layers'][10]['config']['target_shape'] = (-1, 16)
    config['layers'][11]['config']['layer']['config']['kernel_initializer'] = 'zeros'
    config['layers'][12]['config']['kernel_initializer'] = 'zeros'
    ...
    del json_dic['config']['layers'][8]['config']['layer']['config']['time_major']
    del json_dic['config']['layers'][8]['config']['layer']['config']['zero_output_for_mask']
    del json_dic['config']['layers'][11]['config']['layer']['config']['time_major']
    del json_dic['config']['layers'][11]['config']['layer']['config']['zero_output_for_mask']
