...
from target_train import DoubleRelu, VoiceGeneratorTarget
...
if __name__ == '__main__':
    ...
    model.fit_generator(VoiceGeneratorTarget(sys.argv[2], 0.1, batch_size, length, train=True),
        shuffle=True,
        epochs=100000,
        verbose=1,
        callbacks=callbacks,
        validation_data=VoiceGeneratorTarget(sys.argv[2], 0.1, batch_size, train=False)
    )
